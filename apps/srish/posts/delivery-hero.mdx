...
As this was a large-scale project, I suggested my team to break it down into smaller, manageable tasks. This approach allowed us to ensure that the existing functionalities under Mass Uploads remained usable for our users and that they could gradually adjust to the new flow.
...
{/* <ImageGallery
  images={[
    {
      src: 'https://cdn-images-1.medium.com/max/1600/1*3LVYQFiLt2QTxBb_5YFY-Q@2x.png',
      alt: 'Usage of mass uploads feature',
    },
  ]}
  caption="Mass Upload User Needs"
/> */}
...
{/* <ImageGallery
  ...
  images={[
    {
      src: 'https://cdn-images-1.medium.com/max/1600/1*g7H88EMhEyYTGUd7EXFjyA@2x.png',
      alt: 'Phase 1 (in scope)— User Flow',
      caption: 'Phase 1 (in scope)— User Flow',
    },
    {
      src: "https://cdn-images-1.medium.com/max/1600/1*h0cz9PrlIcc9RIM2CF6Cpg@2x.png",
      alt: "Phase 1 — Out of scope",
      caption: "Phase 1 — Out of scope",
    }
  ]}
/> */}
...
{/* <ImageGallery
  images={[
    {
      src: 'https://cdn-images-1.medium.com/max/1600/1*MfHUAjMwOCcmcPteaAEe3Q.gif',
...
To make the experience seamless & error free, we worked on following improvements in mind:
...
{/* <ImageGallery
  ...
  images={[
    {
      src: 'https://cdn-images-1.medium.com/max/800/1*3E1GknkUI3lH4L9W3YGNqQ@2x.png',
      alt: 'TODO',
    },
    {
      src: 'https://cdn-images-1.medium.com/max/800/1*Inygf4CwZzhkT7sVrEBH9g@2x.png',
      alt: 'TODO',
    },
    {
      src: 'https://cdn-images-1.medium.com/max/1200/1*nj8uO-cc9kcylKcMo-VXSw.png',
      alt: 'TODO',
    },
  ]}
  caption="Update the Help Documentation & link it on the UI"
/> */}
...
{/* <ImageGallery
  ...
  images={[
    {
      src: 'https://cdn-images-1.medium.com/max/1200/1*2xiEphePFuo0hzDwOWYnnw@2x.png',
      alt: 'TODO',
    },
    {
      src: 'https://cdn-images-1.medium.com/max/1200/1*R_z37yij30lI6fJFxyc57g@2x.png',
      alt: 'TODO',
    },
  ]}
...
Once the design was finalised, it was eagerly handed over to the front-end developer who has already begun the exciting process of bringing the design to life. I always also try to document all the changes and the rationale behind them whether it is a team decision due to business impact, team effort or UX decision due to users feedback etc

{/* <ImageGallery
  images={[
    {
      src: 'https://cdn-images-1.medium.com/max/1600/1*4dLr0eko1NsFYeS3jEb_cw@2x.png',
      alt: 'TODO',
    },
  ]}
/> */}
...
Once the designs were implemented on the Production, I eagerly created a Hotjar survey to gather the SEQ/Satisfaction score on the updated flow for Mass Uploads in TES.

{/* <ImageGallery
  images={[
    {
      src: 'https://cdn-images-1.medium.com/max/1200/1*seve1nTOEXBBhKqpQe2CNg.png',
      alt: 'TODO',
    },
    {
      src: 'https://cdn-images-1.medium.com/max/1600/1*3w55jKY728vAt4qDJEoo3Q.png',
      alt: 'TODO',
    },
  ]}
/> */}

So far we got 17 responses on the above survey and the **achieved Satisfaction score is 7.6/10.**

### **Next Steps**

The next step includes **monitoring** and **tracking the progress of the updated restructure of Mass Uploads** via Google Analytics.

Other than monitoring, we had to think about the completion of the whole Mass Uploads feature which included the following:

- **Updating our Help Documentation (**still something to take care of!!!)
- And **implementing the rest of the Mass Upload actions**, a frontend task that is not completed yet.

{/* <ImageGallery
  images={[
    {
      src: 'https://cdn-images-1.medium.com/max/1600/1*7azIIx0J7trLzNBRzJZxzA@2x.png',
      alt: "TODO"
    },
  ]}
  caption="Complete Mass Upload Feature with all the actions"
/> */}

### Learnings

This project has been an incredibly exciting and interesting experience for me, and it's still ongoing. Here are some key learnings I've taken away from this initiative:

**Using Maze for Usability Testing of the Updated Designs**
...
- While Maze was a great resource, **I realised that my approach to conducting user interviews was somewhat biased due to testing prototypes in Maze**. Every link is not clickable in a prototype (though users might not know that) thus some of analysis like click rate is not 100% accurate as it is a prototype and not a real product.
- After reviewing the results, I discovered that the **first idea was more challenging for users**, as they were trying to comprehend the task provided to them. By the time they got to the second idea, they already understood the task well.
- In hindsight, it would have been better to **randomly assign each user an idea** to consider.

**Planning & Execution**

- Since this was a large initiative, **our roadmap estimations could have been more accurate**. I believe it took longer than expected.
